...
```     
    ...
    asdf list-all erlang # review output and pick late stable version
...
```
    ...
    asdf list-all elixir # review output and pick late stable version
...
```
     ...
     nvm ls-remote # review output and pick late stable version
     nvm install <version>
     nvm use <version>  
```
...
File: `myapp/assets/js/SimpleRoot.re`
Code:
```
     ReactDOMRe.renderToElementWithId(<Page message="Hello!" />, "index");  
```

File: `myapp/assets/js/Page.re`
Code:
```
...
File: `myapp/assets/bsconfig.json`
Code:
```
     {  
      "name": "myapp",  
...
File: `myapp/lib/myapp_web/templates/page/index.html.eex`
Code:
```
      <div id="index"></div>  
```
